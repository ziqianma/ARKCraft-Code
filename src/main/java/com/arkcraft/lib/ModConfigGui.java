...
public class ModConfigGui extends GuiConfig {
	...
	public static class Mod1BalanceEntry extends CategoryEntry {
		private static List<IConfigElement> getConfigElements() {
			...
			list.addAll(new ConfigElement(Mod1Config.config.getCategory(Mod1Config.CATEGORY_BALANCE)).getChildElements());
			return list;
		}
		...
		protected GuiScreen buildChildScreen() {
			return new GuiConfig(this.owningScreen, getConfigElements(), this.owningScreen.modID, Mod1Config.CATEGORY_BALANCE, 
	...
	public static class Mod2BalanceEntry extends CategoryEntry {
		private static List<IConfigElement> getConfigElements() {
			...
			list.addAll(new ConfigElement(Mod2Config.config.getCategory(Mod2Config.CATEGORY_BALANCE)).getChildElements());
			return list;
		}
		...
		@Override
		protected GuiScreen buildChildScreen() {
			return new GuiConfig(this.owningScreen, getConfigElements(), this.owningScreen.modID, Mod2Config.CATEGORY_BALANCE, 
					false, false, ARKCraft.NAME + " Balance Settings");
		}
	}
