package com.arkcraft.mod2.common.config;
...
public class Mod2Config {
	...
	private static void balanceCategoryConfiguration() {
		...
		loadFields(cat_balance, MOD2_BALANCE.PLANTS.class);
		loadFields(cat_balance, MOD2_BALANCE.PLAYER.class);
		loadFields(cat_balance, MOD2_BALANCE.WEAPONS.class);		
		loadFields(cat_balance, MOD2_BALANCE.CROP_PLOT.class);		
