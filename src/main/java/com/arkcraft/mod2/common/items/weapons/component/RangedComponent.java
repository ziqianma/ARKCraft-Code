...
//			return EnumAction.BLOCK;
	...
	public static enum RangedSpecs {
		...
		private int getReloadTime(int id){
			switch (id) {
			case 0:
				return (int)(MOD2_BALANCE.WEAPONS.SIMPLE_PISTOL_RELOAD * 20.0);
			case 1:
				return (int)(MOD2_BALANCE.WEAPONS.ROCKET_LAUNCHER_RELOAD * 20.0);
			case 2:
				return (int)(MOD2_BALANCE.WEAPONS.SHOTGUN_RELOAD * 20.0);
			case 3:
				return (int)(MOD2_BALANCE.WEAPONS.LONGNECK_RIFLE_RELOAD * 20.0);
			case 4:
				return (int)(MOD2_BALANCE.WEAPONS.TRANQ_GUN_RELOAD * 20.0);
			case 5:
				return (int)(MOD2_BALANCE.WEAPONS.CROSSBOW_RELOAD * 20.0);
			default:
