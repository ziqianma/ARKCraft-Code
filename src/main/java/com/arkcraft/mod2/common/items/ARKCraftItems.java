...
import com.arkcraft.mod2.common.entity.item.projectiles.dispense.DispenseSimpleShotgunAmmo;
import com.arkcraft.mod2.common.entity.item.projectiles.dispense.DispenseTranquilizer;
...
import com.arkcraft.mod2.common.items.weapons.component.RangedCompLongneckRifleScoped;
import com.arkcraft.mod2.common.items.weapons.component.RangedCompRocketLauncher;
...
public class ARKCraftItems
{
	...
	//	metal_arrow = addItemProjectile("metal_arrow");
		...
		dodo_feces = addFecesItem("dodo_feces", MOD2_BALANCE.CROP_PLOT.SECONDS_FOR_SMALL_FECES_TO_DECOMPOSE);
		player_feces = addFecesItem("player_feces", MOD2_BALANCE.CROP_PLOT.SECONDS_FOR_PLAYER_FECES_TO_DECOMPOSE);
		
		// Technically not feces, but used in all situations the same (currently)
		fertilizer = addFecesItem("fertilizer", MOD2_BALANCE.CROP_PLOT.SECONDS_FOR_FERTILIZER_TO_DECOMPOSE);
