...
public class TileInventoryCompostBin extends TileEntity implements IInventory, IUpdatePlayerListBox {
	...
	private static int compostTimeInitialValue = MOD2_BALANCE.COMPOST_BIN.COMPOST_TIME_FOR_THATCH;
	...
	private static final short COMPOST_TIME_FOR_FECES = (short) MOD2_BALANCE.COMPOST_BIN.COMPOST_TIME_FOR_FECES;
