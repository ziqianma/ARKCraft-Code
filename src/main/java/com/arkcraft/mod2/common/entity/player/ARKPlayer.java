package com.arkcraft.mod2.common.entity.player;
...
import com.arkcraft.mod2.common.container.inventory.InventoryPlayerCrafting;
import com.arkcraft.mod2.common.handlers.PlayerCraftingManager;
import com.arkcraft.mod2.common.network.PlayerPoop;
import com.arkcraft.mod2.common.network.SyncPlayerData;
...
//		LogHelper.info("ARKPlayer loadNBTData: Player can " + (canPoop ? "" : "not") + " poop.");
	...
	private InventoryBlueprints inventoryBlueprints = new InventoryBlueprints("Blueprints", false, 
			...
			(short) MOD2_BALANCE.PLAYER_CRAFTING.CRAFT_TIME_FOR_ITEM);
