...
public class Test extends Entity implements IProjectile
{
    ...
    public Test(World worldIn, EntityLivingBase shooter, float speed, float inaccuracy)
    {
        super(worldIn);
    ...
    public Test(World worldIn, EntityLivingBase shooter, float speed)
    {
        super(worldIn);
        this.shootingEntity = shooter;
