...
public class BlockCompostBin extends BlockContainer
{
    ...
    public static final PropertyEnum PART = PropertyEnum.create("part", BlockCompostBin.EnumPartType.class);
    ...
    public BlockCompostBin(Material mat, int ID)
    {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(PART, BlockCompostBin.EnumPartType.LEFT));
    }
...
//        else if (worldIn.getBlockState(pos.offset(enumfacing)).getBlock() != this) { // Original, from bed
    ...
    public IBlockState getStateFromMeta(int meta)
    {
        ...
        return (meta & 8) > 0 ? this.getDefaultState().withProperty(PART, BlockCompostBin.EnumPartType.LEFT).withProperty(FACING, enumfacing)
                : this.getDefaultState().withProperty(PART, BlockCompostBin.EnumPartType.RIGHT).withProperty(FACING, enumfacing);
    }
