...
public class RangedCompFabricatedPistol extends RangedComponent
{
    public RangedCompFabricatedPistol()
    {
        super(RangedSpecs.FABRICATEDPISTOL);
    }
  ...
  //      world.playSoundAtEntity(entityplayer, "random.door_close", 0.7F, 0.9F / (weapon.getItemRand().nextFloat() * 0.2F + 0.0F));
        world.playSoundAtEntity(entityplayer, ARKCraft.MODID + ":" + "fabricated_pistol_reload", 0.7F, 0.9F / (weapon.getItemRand().nextFloat() * 0.2F + 0.0F));
  ...
  //      world.playSoundEffect(x, y, z, "ambient.weather.thunder", 1.5F, 1F / (weapon.getItemRand().nextFloat() * 0.4F + 0.4F));
        world.playSoundEffect(x, y, z,  ARKCraft.MODID + ":" + "fabricated_pistol_shoot", 1.5F, 1F / (weapon.getItemRand().nextFloat() * 0.4F + 0.7F));
