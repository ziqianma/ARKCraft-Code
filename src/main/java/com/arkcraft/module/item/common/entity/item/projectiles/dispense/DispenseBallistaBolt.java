package com.arkcraft.module.item.common.entity.item.projectiles.dispense;
...
//		double z = MathHelper.floor_double(blockpos.getZ());
        ...
        if (tileentity instanceof TileEntityDispenser)
        {
            ...
            {
                itemtocheck = ARKCraftItems.ballista_bolt;
            }
            else if (itemstack.getItem() == ARKCraftItems.ballista_bolt)
            {
        ...
        EntityBallistaBolt entityballistabolt = new EntityBallistaBolt(blocksource.getWorld(), pos.getX() + xvel, pos.getY() + yvel, pos.getZ() + zvel);
