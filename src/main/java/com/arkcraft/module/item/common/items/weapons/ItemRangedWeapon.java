...
public class ItemRangedWeapon extends ItemBow implements IItemWeapon
{
	...
	{
		return new ModelResourceLocation(String.format(
				new TileInventoryAttachment2(stack).getModel(),
				this.rangedComponent instanceof RangedCompLongneckRifle ? "longneck_rifle" : ""),
				"inventory");
	}
