...
import com.arkcraft.module.item.common.blocks.BlockCropPlot;
import com.arkcraft.module.item.common.config.ModuleItemBalance;
import com.arkcraft.module.item.common.items.ItemARKSeed;
...
public class TileInventoryCropPlot extends TileEntity implements IInventory, IUpdatePlayerListBox
{
     ...
     */
    private short waterTimeInitialValue = (short) ModuleItemBalance.CROP_PLOT.SECONDS_OF_WATER_PER_BUCKET; // vanilla value is 1080 = 18 minutes
    /**
     ...
     */
    private static final short GROW_TIME_FOR_BERRY = (short) ModuleItemBalance.CROP_PLOT.GROW_TIME_FOR_BERRY;  // vanilla value is 45 seconds
