...
public class ModelRaptor extends ModelBase
{
	...
	public ModelRaptor()
	{
		...
		this.Head.addChild(this.HeadFeathers6_6);
		this.LowerSnout1.addChild(this.teeth_8);
		...
		this.LowerBoddy2.addChild(this.HeadFeathers6_9);
		this.Chest.addChild(this.HeadFeathers6_3);
		...
		this.LowerSnout1.addChild(this.teeth_2);
		this.RightUpperArm.addChild(this.RightArmFeathers5);
		this.LeftEyeball.addChild(this.LeftPupill);
		this.UpperBoddy.addChild(this.HeadFeathers6);
		this.Head.addChild(this.HeadFeathers1);
		this.Neck.addChild(this.HeadFeathers6_4);
		this.LowerSnout1.addChild(this.teeth_1);
		this.LowerSnout1.addChild(this.teeth_3);
		this.LowerBoddy2.addChild(this.HeadFeathers6_7);
		...
		this.LowerSnout1.addChild(this.teeth_5);
		...
		this.UpperBoddy.addChild(this.HeadFeathers6_1);
		...
		this.LowerSnout1.addChild(this.teeth_4);
		this.LeftMiddleFoot.addChild(this.LeftMiddleClaw);
		this.RightUpperArm.addChild(this.RghtArmFeathers1);
		this.LowerBoddy2.addChild(this.HeadFeathers6_8);
		this.LowerSnout1.addChild(this.teeth_10);
