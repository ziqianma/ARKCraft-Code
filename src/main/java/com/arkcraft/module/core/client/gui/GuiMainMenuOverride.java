...
public class GuiMainMenuOverride extends GuiScreen implements GuiYesNoCallback
{
    ...
    private static final ResourceLocation arkcraftTitle = new ResourceLocation(ARKCraft.MODID, "textures/gui/arkcraft_logo.png");
    /**
     * An array of all the paths to the panorama pictures.
     */
    private static final ResourceLocation[] titlePanoramaPaths = new ResourceLocation[] { new ResourceLocation(ARKCraft.MODID, "textures/gui/panorama_0.png"), new ResourceLocation(ARKCraft.MODID, "textures/gui/panorama_1.png"), new ResourceLocation(ARKCraft.MODID, "textures/gui/panorama_2.png"), new ResourceLocation(ARKCraft.MODID, "textures/gui/panorama_3.png"), new ResourceLocation(ARKCraft.MODID, "textures/gui/panorama_4.png"), new ResourceLocation(ARKCraft.MODID, "textures/gui/panorama_5.png") };
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiARKButton(0, this.width / 2 - 100, i + 72 + 12, 98, 20, I18n.format("menu.options", new Object[0])));
        this.buttonList.add(new GuiARKButton(4, this.width / 2 + 2, i + 72 + 12, 98, 20, I18n.format("menu.quit", new Object[0])));
    ...
    {
        this.buttonList.add(new GuiARKButton(1, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1, I18n.format("Host / Local", new Object[0]))); //TODO lang
        this.buttonList.add(new GuiARKButton(2, this.width / 2 - 100, p_73969_1_, I18n.format("Join ARK", new Object[0])));
        this.buttonList.add(this.realmsButton = new GuiARKButton(14, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("menu.online", new Object[0])));
        GuiARKButton fmlModButton = new GuiARKButton(6, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("fml.menu.mods"));
    ...
    {
        this.buttonList.add(new GuiARKButton(11, this.width / 2 - 100, p_73972_1_, I18n.format("menu.playdemo", new Object[0])));
        this.buttonList.add(this.buttonResetDemo = new GuiARKButton(12, this.width / 2 - 100, p_73972_1_ + p_73972_2_ * 1, I18n.format("menu.resetdemo", new Object[0])));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, ARKCraft.NAME + " - " + ARKCraft.VERSION, this.width / 2, this.height - 20, 0xFFFF00);
        ...
        if (this.openGLWarning1 != null && this.openGLWarning1.length() > 0)
        {
            ...
            this.drawString(this.fontRendererObj, this.openGLWarning2, (this.width - this.field_92024_r) / 2, ((GuiARKButton) this.buttonList.get(0)).yPosition - 12, -1);
        }
