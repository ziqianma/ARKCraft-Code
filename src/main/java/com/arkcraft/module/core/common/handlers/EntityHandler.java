...
public class EntityHandler
{
    ...
    public static void registerEntityEgg(Class eClass, String name, BiomeGenBase... biomes)
    {
        ...
        EntityRegistry.addSpawn(eClass, CoreBalance.DINO_PROPERTIES.SPAWN_PROBABILITY, 2, 4, EnumCreatureType.CREATURE, biomes);
...
//		EntityRegistry.registerModEntity(eClass, name, entityID, ARKCraft.instance(), 64, 10, true);
