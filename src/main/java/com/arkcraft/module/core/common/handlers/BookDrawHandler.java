...
import com.arkcraft.module.core.client.gui.GuiDossierScreen.CATEGORY;
...
public class BookDrawHandler
{
    ...
    public enum DINO_NAME
    {
        ...
        public ResourceLocation getPreferenceImage()
        {
            ...
            if (this.getPreference() == "Herbivore")
            {
                location = new ResourceLocation(ARKCraft.MODID, "textures/items/amar.png");
            }
            if (this.getPreference() == "Carnivore")
            {
                location = new ResourceLocation(ARKCraft.MODID, "textures/items/primemeat_raw.png");
            }
            if (this.getPreference() == "Omnivore")
            {
                location = new ResourceLocation(ARKCraft.MODID, "textures/items/amar.png");
            }
            return location;
    ...
    {
		/* Draws this on left */
        renderer.drawString(dinoName.getName(), getLeft() + 5 - dinoName.getName().length(), 45, Color.darkGray.getRGB());
    }
