...
public class Mod1Config {
	...
	private static void balanceCategoryConfiguration() {
		...
		loadFields(cat_balance, MOD1_BALANCE.GEN.class);
		loadFields(cat_balance, MOD1_BALANCE.DINO_PROPERTIES.class);		
