...
public class RangedCompTranqGun extends RangedComponent
{
	...
	public void effectReloadDone(ItemStack itemstack, World world, EntityPlayer entityplayer)
	{
		...
		world.playSoundAtEntity(entityplayer, ARKCraft.MODID + ":" + "reload_tranq_gun", 1.2F, 1.0F / (weapon.getItemRand().nextFloat() * 0.2F + 0.0F));
	}
	...
	{
		world.playSoundEffect(x, y, z,  ARKCraft.MODID + ":" + "shoot_tranq_gun", 3F, 1F / (weapon.getItemRand().nextFloat() * 0.4F + 0.7F));
