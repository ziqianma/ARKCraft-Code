...
import com.arkcraft.mod.common.blocks.BlockInventoryCompostBin;
...
public class ARKCompostBinItem extends Item
{
    public ARKCompostBinItem(String name) {
    	super();
...
//            BlockPos blockpos1 = pos.offset(enumfacing1); // like a bed, placed vertically
            ...
            if (playerIn.canPlayerEdit(pos, side, stack) && playerIn.canPlayerEdit(blockpos1, side, stack)) {
                if (flag2 && flag3 && World.doesBlockHaveSolidTopSurface(worldIn, pos.down()) && World.doesBlockHaveSolidTopSurface(worldIn, blockpos1.down())){
                    IBlockState iblockstate1 = ARKCraftBlocks.compost_bin.getDefaultState()
                    		.withProperty(BlockInventoryCompostBin.FACING, enumfacing1)
                    		.withProperty(BlockInventoryCompostBin.PART, BlockInventoryCompostBin.EnumPartType.RIGHT);
                    if (worldIn.setBlockState(pos, iblockstate1, 3)){
                        IBlockState iblockstate2 = iblockstate1
                        		.withProperty(BlockInventoryCompostBin.PART, BlockInventoryCompostBin.EnumPartType.LEFT);
