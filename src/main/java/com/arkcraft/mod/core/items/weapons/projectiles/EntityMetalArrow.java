...
public class EntityMetalArrow extends EntityArrow{
	 ...
	 public EntityMetalArrow(World worldIn)
	    ...
	    public EntityMetalArrow(World worldIn, EntityLivingBase shooter, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
	    {
	        super(worldIn);
	        this.renderDistanceWeight = 10.0D;
	    ...
	    public EntityMetalArrow(World worldIn, EntityLivingBase shooter, float p_i1756_3_)
	    {
	        super(worldIn);
	        this.renderDistanceWeight = 10.0D;
	        this.shootingEntity = shooter;
