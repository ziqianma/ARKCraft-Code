...
public class CropPlotCrops extends ARKBush implements IPlaceable
{
    public static final PropertyInteger GROWTH = PropertyInteger.create("growth", 0, 11);

    protected CropPlotCrops()
    {
...
//    }
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
    {
        ...
        if (worldIn.getLightFromNeighbors(pos.up()) >= 9)
        {
            ...
            if (i < 11)
            {
                ...
                {
                    worldIn.setBlockState(pos, state.withProperty(GROWTH, Integer.valueOf(i + 1)), 2);
                }
            }
        }
    }
    ...
    {
        int i = ((Integer)state.getValue(GROWTH)).intValue() + MathHelper.getRandomIntegerInRange(worldIn.rand, 2, 5);
        ...
        worldIn.setBlockState(pos, state.withProperty(GROWTH, Integer.valueOf(i)), 2);
    }
    ...
    {
        return ((Integer)state.getValue(GROWTH)).intValue() < 11;
    }
    ...
    public java.util.List<ItemStack> getDrops(net.minecraft.world.IBlockAccess world, BlockPos pos, IBlockState state, int fortune)
    {
        ...
        int age = ((Integer)state.getValue(GROWTH)).intValue();
