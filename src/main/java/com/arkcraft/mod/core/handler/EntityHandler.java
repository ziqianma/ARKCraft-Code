...
//		EntityRegistry.addSpawn(eClass, 50, 2, 4, EnumCreatureType.CREATURE, BiomeGenBase.beach, BiomeGenBase.desert, BiomeGenBase.forest, BiomeGenBase.birchForest, BiomeGenBase.extremeHills);
		EntityRegistry.addSpawn(eClass, 50, 2, 4, EnumCreatureType.CREATURE, BiomeGenBase.birchForest, BiomeGenBase.plains, BiomeGenBase.savanna, BiomeGenBase.beach, BiomeGenBase.desert, BiomeGenBase.forest, BiomeGenBase.birchForest, BiomeGenBase.extremeHills);
